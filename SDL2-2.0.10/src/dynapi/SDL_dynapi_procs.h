...
SDL_DYNAPI_PROC(SDL_bool,SDL_FRectHasIntersection,(const SDL_FRect *a, const SDL_FRect *b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_EncloseFPoints,(const SDL_FPoint *a, int b, SDL_FRect *d),(a,b,d),return)
